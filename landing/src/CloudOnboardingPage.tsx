    ...
    <div className="landing-page cloud-page">
      ...
      <header className="site-header">
        <nav className="site-nav" aria-label="Primary">
          <button className="cloud-nav-button" type="button" onClick={() => navigate(buildLocalizedPath(currentLanguage, "/cloud"))}>
            Chatons Cloud
          </button>
      ...
      <main className="site-main cloud-main">
        <section className="cloud-onboarding-grid cloud-onboarding-grid-wide">
          <CloudSetupStatus
          ...
          <div className="cloud-onboarding-stack">
