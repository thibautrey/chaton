(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      '.ce-root { color: var(--ce-fg); font-family: var(--ce-font); }',
      ...
      '.ce-button--default:hover { background: hsl(220 7% 28%); }',
      ...
      '.ce-card { background: rgba(255,255,255,0.82); border: 1px solid rgba(255,255,255,0.85); box-shadow: var(--ce-shadow-card); backdrop-filter: blur(18px); border-radius: var(--ce-radius-lg); }',
      ...
      '.ce-list-row { display: flex; align-items: flex-start; justify-content: space-between; gap: 12px; border: 1px solid var(--ce-border); background: rgba(255,255,255,0.7); border-radius: 16px; padding: 14px 16px; }',
      ...
      '.ce-empty { border: 1px dashed var(--ce-border); border-radius: 16px; padding: 18px; color: var(--ce-muted-fg); background: rgba(255,255,255,0.5); }',
      ...
      '.ce-modal-backdrop { position: fixed; inset: 0; background: rgba(15, 23, 42, 0.24); backdrop-filter: blur(4px); display: none; align-items: center; justify-content: center; padding: 24px; z-index: 999; }',
      '.ce-modal-backdrop.is-open { display: flex; }',
      '.ce-modal { width: min(1040px, 100%); max-height: calc(100vh - 48px); overflow: auto; background: linear-gradient(180deg, rgba(255,255,255,0.96), rgba(248,250,252,0.96)); border: 1px solid rgba(255,255,255,0.85); box-shadow: var(--ce-shadow-dialog); border-radius: 24px; padding: 22px; }',
      ...
      '.ce-callout { border: 1px solid hsl(214 90% 85%); background: hsl(214 100% 97%); border-radius: 16px; padding: 14px; }',
