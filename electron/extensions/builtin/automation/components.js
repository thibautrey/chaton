(function () {
  ...
  function ensureStyles() {
    ...
    style.textContent = [
      ...
      ".ce-auto { min-height: 100vh; background: var(--ce-bg); color: var(--ce-fg); }",
      ...
      ".ce-auto-detail { background: color-mix(in srgb, var(--ce-bg) 99%, white); display: flex; align-items: center; justify-content: center; padding: 28px; position: relative; }",
      ...
      ".ce-auto-detail-card { display: none; width: min(740px, 100%); border: 1px solid var(--ce-border); border-radius: 14px; background: var(--ce-card); box-shadow: var(--ce-shadow-card); padding: 18px; }",
      ".ce-auto-detail-title { margin: 0; font-size: 24px; letter-spacing: -0.01em; }",
      ".ce-auto-detail-meta { margin: 6px 0 0; color: var(--ce-muted-fg); font-size: 14px; }",
      ".ce-auto-detail-body { margin: 14px 0 0; padding: 0; max-height: 58vh; overflow: auto; }",
      ...
      ".ce-auto-detail-grid { display: grid; gap: 8px; }",
      ".ce-auto-kv { display: grid; gap: 3px; padding: 9px 10px; border-radius: 10px; border: 1px solid var(--ce-border); background: color-mix(in srgb, var(--ce-card) 90%, var(--ce-muted)); }",
      ".ce-auto-k { color: var(--ce-muted-fg); font-size: 12px; }",
      ".ce-auto-v { color: var(--ce-fg); font-size: 13px; word-break: break-word; }",
      ".ce-auto-v--mono { font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, monospace; font-size: 12px; }",
      ...
      ".ce-auto-detail-code { margin: 0; padding: 10px; border-radius: 10px; border: 1px solid var(--ce-border); background: var(--ce-muted); color: var(--ce-fg); font-size: 12px; line-height: 1.45; overflow: auto; font-family: ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, Liberation Mono, monospace; }",
      ".ce-auto-error-box { border: 1px solid color-mix(in srgb, var(--ce-danger) 45%, var(--ce-border)); background: color-mix(in srgb, var(--ce-danger-soft) 70%, var(--ce-card)); color: var(--ce-danger); border-radius: 10px; padding: 10px; font-size: 13px; line-height: 1.45; white-space: pre-wrap; word-break: break-word; }",
