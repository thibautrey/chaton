...
| `index.html` | Yes | Extension UI entry point |
...
This shows what files will be included in the package. Make sure your HTML, CSS, JS, and manifest are listed.
...
5. Chatons runs `npm publish` for you
