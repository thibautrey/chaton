...
Queue payloads must be JSON-serializable and are limited to 256 KiB after JSON serialization. Topics, consumer IDs, message IDs, dates, and idempotency keys are validated before messages are persisted.
