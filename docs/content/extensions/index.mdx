...
**Start here:** If you're new to extensions, start with the Extensions Tutorial -- it has a complete working example.

**Reference:** For API details, see the [Extensions API](/extensions/api).

**Related documents:**

- [Extensions API](/extensions/api) -- API reference and method signatures
- [Extensions Channels](/extensions/channels) -- Building messaging platform integrations
...
- [Automation Extension](/automation-extension) -- Built-in automation extension details
...
For the full UI helper reference, see the [Extensions UI Library](/extensions/ui-library).
