...
The desktop login flow is expected to open the user browser to `cloud.chatons.ai`, then return to the desktop app through the custom `chatons://cloud/auth/callback` protocol.
