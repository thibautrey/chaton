...
"[project]/gitRepo/dashboard/docs/node_modules/fumadocs-core/dist/advanced-D8-Cn2tE.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function searchSimple(db, query, params = {}) {
    ...
    return (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$search$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["search"])(db, {
        term: query,
        tolerance: 1,
        ...params,
        boost: {
...
async function searchAdvanced(db, query, tag = [], { mode = "fulltext", ...override } = {}) {
    ...
    const highlighter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$search$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createContentHighlighter"])(query);
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$search$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["search"])(db, params);
    const list = [];
    for (const item of result.groups ?? []){
        const pageId = item.values[0];
        const page = (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$docs$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getByID"])(db, pageId);
        if (!page) continue;
        list.push({
            id: pageId,
            type: "page",
...
"[project]/gitRepo/dashboard/docs/node_modules/fumadocs-core/dist/static-dXiDJ_Bs.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$advanced$2d$D8$2d$Cn2tE$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/gitRepo/dashboard/docs/node_modules/fumadocs-core/dist/advanced-D8-Cn2tE.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/gitRepo/dashboard/docs/node_modules/@orama/orama/dist/esm/index.js [app-ssr] (ecmascript) <locals>");
...
async function loadDB({ from = "/api/search", initOrama = (locale)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$create$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])({
        schema: {
            _: "string"
        },
        language: locale
    ...
    async function init() {
        ...
        if (data.type === "i18n") {
            await Promise.all(Object.entries(data.data).map(async ([k, v])=>{
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$serialization$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["load"])(db, v);
                dbs.set(k, {
                    type: v.type,
                    db
                });
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f40$orama$2f$orama$2f$dist$2f$esm$2f$methods$2f$serialization$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["load"])(db, data);
        dbs.set("", {
            type: data.type,
            db
        });
...
async function search(query, options) {
    ...
    if (!db) return [];
    if (db.type === "simple") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$advanced$2d$D8$2d$Cn2tE$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"])(db, query);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$gitRepo$2f$dashboard$2f$docs$2f$node_modules$2f$fumadocs$2d$core$2f$dist$2f$advanced$2d$D8$2d$Cn2tE$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["t"])(db.db, query, tag);
}
;
}),
];

//# sourceMappingURL=gitRepo_dashboard_e654adfa._.js.map