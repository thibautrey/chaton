...
export type WorkspaceContextValue = {
  ...
  openCloudLogin: () => Promise<void>
  openCloudSignup: () => Promise<void>
  ...
  openExtensionConfigSheet: (viewId: string, title: string) => void
  closeExtensionConfigSheet: () => void
